...
This document provides guidelines for internationalization of the GeekCash software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `geekcash_en.ts` remains unchanged.
