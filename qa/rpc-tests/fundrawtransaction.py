...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid geekcash address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid geekcash address" in e.error['message'])
