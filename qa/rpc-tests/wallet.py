...
class WalletTest (BitcoinTestFramework):
    ...
    def run_test (self):
        ...
        # Send 210 GEEK from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 100K GEEK in block rewards plus fees, but
        ...
        # Send 100 GEEK with subtract fee from amount
        ...
        # Sendmany 100 GEEK with subtract fee from amount
